...
int make_img_main(char *szSourceSring, char * _Filename)
{
 ...
 */
	...
	if (pQRC = QRcode_encodeString(szSourceSring, 0, QR_ECLEVEL_H, QR_MODE_8, 1))
		...
		BITMAPFILEHEADER_qrg kFileHeader;
		kFileHeader.bfType = 0x4d42;  // "BM"
		kFileHeader.bfSize =	sizeof(BITMAPFILEHEADER_qrg) +
								sizeof(BITMAPINFOHEADER_qrg) +
								unDataBytes;
		kFileHeader.bfReserved1 = 0;
		kFileHeader.bfReserved2 = 0;
		kFileHeader.bfOffBits =	sizeof(BITMAPFILEHEADER_qrg) +
								sizeof(BITMAPINFOHEADER_qrg);

		BITMAPINFOHEADER_qrg kInfoHeader;
		kInfoHeader.biSize = sizeof(BITMAPINFOHEADER_qrg);
		...
		if (!(fopen_s(&f, _Filename, "wb")))
		{
			fwrite(&kFileHeader, sizeof(BITMAPFILEHEADER_qrg), 1, f);
			fwrite(&kInfoHeader, sizeof(BITMAPINFOHEADER_qrg), 1, f);
