...
typedef enum
{
	...
	MESSAGE_NOT_CHIP_PARA,				    //没有参数
	MESSAGE_SET_EX_PARA_FAIL,			    //传参数
	...
	MESSAGE_GET_PARTITION_FAIL,              //获取分区不对
	...
	MESSAGE_GETPARTITION_NAME_FAIL,
	MESSAGE_GET_PARTITION_SIZE_FAIL,        //获取分区大小错误
	MESSAGE_WRITE_ENV_START,
	MESSAGE_WRITE_ENV_FAIL,                 //写环境变量出错

	MESSAGE_PARTITION_NAME_ERROR,
	MESSAGE_SPIFLASH_IMG_NUM_ERROR,
	MESSAGE_DOWNLOAD_SPIFLASH_IMG_FAIL,
	MESSAGE_DOWNLOAD_SPIFLASH_IMG_START,
	MESSAGE_DOWNLOAD_SPIFLASH_IMG_FINISH,

	MESSAGE_GETPARTITION_NAME_lEN_ERROR,

	MESSAGE_START_ERASE_PARTITON,   //开始擦分区的块
	MESSAGE_ERASE_PARTITON_ERROR,  //擦分区的块失败
	MESSAGE_CHECK_FS_TYPE_ERROR,  //检查文件系统类型出错
	MESSAGE_ERASE_BLOCK_NUM_ERROR,  //

	MESSAGE_GET_BT_ADDR_START,
	MESSAGE_GET_BT_ADDR_MORE_END,
	MESSAGE_GET_BT_ADDR_LEN_ERROR,
	MESSAGE_GET_BT_ADDR_ERROR,
	MESSAGE_WRITE_BT_ADDR_FAIL,
	MESSAGE_WRITE_BT_ADDR_START,

	MESSAGE_BURN_BLUE_ADDR_SHOW,
