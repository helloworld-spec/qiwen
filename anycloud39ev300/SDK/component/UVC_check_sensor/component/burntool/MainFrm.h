...
public:
	...
	void OnBlueAddr(int port, BOOL falg);
...
protected:
	...
	afx_msg void OnCheckNoFixed();
	afx_msg void OnCheckUdiskMassboot();
	afx_msg void OnCheckEraseFileSize();
	afx_msg void OnCheckNoNeedErase();
	//}}AFX_MSG
