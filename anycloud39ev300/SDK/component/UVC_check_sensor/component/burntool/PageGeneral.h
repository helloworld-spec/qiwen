...
public:
	...
	BOOL BT_iserror(UINT nID, UINT len, CString str, TCHAR *pBuf);
...
protected:
	...
	afx_msg void OnCheckForceWriteBtAddr();
	afx_msg void OnChangeEditBtStartAddr();
	afx_msg void OnChangeEditBtEndAddr();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
