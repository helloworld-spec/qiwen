...
/**
 * @brief BT_CommitTransc_BlueTest
 *
 * @author  lixingjian
 * @date 2014-11-20
 * @param[in] BOOL Auto_flag
 * @return void
 */
USBTRANSC_API UINT BT_CommitTransc_BlueTest(HANDLE hUSB, T_USB_TRANSC *pTransc);

/**
 * @brief BT_CommitTransc_BurnerID_BlueTest
 *
 * @author lixingjian
 * @date 2014-11-20
 * @param[in] BOOL Auto_flag
 * @return void
 */
USBTRANSC_API UINT BT_CommitTransc_BurnerID_BlueTest(HANDLE hUSB, T_USB_TRANSC *pTransc);

/**
 * @brief BT_CommitTransc_Frequence_OFFSET_BlueTest
 *
 * @author lixingjian
 * @date 2014-11-20
 * @param[in] BOOL Auto_flag
 * @return void
 */
USBTRANSC_API UINT BT_CommitTransc_CaseIdex_data_BlueTest(HANDLE hUSB, T_USB_TRANSC *pTransc);

/**
 * @brief BT_CommitTransc_Case_Config_BlueTest
 *
 * @author lixingjian
 * @date 2014-11-20
 * @param[in] BOOL Auto_flag
 * @return void
 */
USBTRANSC_API UINT BT_CommitTransc_Case_Config_BlueTest(HANDLE hUSB, T_USB_TRANSC *pTransc);
