...
bool setup_clock(unsigned short clk_div, unsigned char clk_pwr_save);
bool send_cmd( unsigned char cmd_index, unsigned char request, unsigned long arg );
...
bool sd_trans_busy();
bool sd_trans_begin(unsigned long size,unsigned char dir);
