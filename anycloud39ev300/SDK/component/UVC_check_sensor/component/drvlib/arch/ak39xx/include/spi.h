...
typedef struct {
    ...
    unsigned char    ucMode;       //phase mode
    unsigned char    ucCS;         //cs state
    unsigned long   clock;        //clock div
    unsigned char    ucRxBufferID;
    unsigned char    ucTxBufferID;
    unsigned long   ulBaseAddr;
    unsigned char    ucL2Tx;
    unsigned char    ucL2Rx;
    unsigned char    ucBusWidth;   //bus width
