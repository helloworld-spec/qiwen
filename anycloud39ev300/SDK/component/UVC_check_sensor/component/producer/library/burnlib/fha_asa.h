...
**************************************************************************/
unsigned long  FHA_asa_scan(bool  bMount);
 ...
 * RETURN:   success return FHA_SUCCESS, fail retuen FHA_ FAIL
**************************************************************************/
unsigned long  FHA_asa_format(unsigned long type);
 ...
 * RETURN:   success return FHA_SUCCESS, fail retuen FHA_ FAIL
**************************************************************************/
unsigned long  FHA_set_bad_block(unsigned long block);
...
**************************************************************************/
bool  FHA_check_bad_block(unsigned long block);
 ...
 * RETURN:   success return FHA_SUCCESS, fail retuen FHA_ FAIL
**************************************************************************/
unsigned long  FHA_get_bad_block(unsigned long start_block, unsigned char *pData, unsigned long blk_cnt);
...
**************************************************************************/
unsigned long  FHA_asa_write_file(unsigned char file_name[], const unsigned char *pData, unsigned long data_len, unsigned char mode);
 ...
 * RETURN:   success return ASA_FILE_SUCCESS, fail retuen ASA_FILE_FAIL
**************************************************************************/
unsigned long  FHA_asa_read_file(unsigned char file_name[], unsigned char *pData, unsigned long data_len);
...
**************************************************************************/
bool  FHA_check_Nand_isused(unsigned char *pBuf, unsigned long len);
 ...
 * RETURN:   success return ASA_FILE_SUCCESS, fail retuen ASA_FILE_FAIL
**************************************************************************/
bool  FHA_Get_factory_badblock_Buf(unsigned char *buf, unsigned long babblock_pagecnt);
 ...
 * RETURN:   is bad block return FHA_SUCCESS, or else retuen FHA_ FAIL
**************************************************************************/
bool FHA_Nand_check_block(unsigned long chip, unsigned long block);
