 ...
 * @param   set_value: true is to enable cpu3x
 * @return  bool
 * @retval  true: cpu frequency three of asic frequency
 * @retval  false: when cpu at 2x or 3x ready.
 */
bool set_cpu_3x(unsigned long pll_value, bool set_value);
