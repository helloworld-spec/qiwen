...
typedef E_NANDERRORCODE (*fNand_MultiReadSector)(T_PNANDFLASH nand, unsigned long chip,
                              unsigned long PlaneNum, unsigned long block, unsigned long page,unsigned char data[], unsigned char* SpareTbl,unsigned long oob_len);	//SpareTbl将是包含MutiPlaneNum个T_MTDOOB缓冲的指针
                              
typedef E_NANDERRORCODE (*fNand_MultiWriteSector)(T_PNANDFLASH nand, unsigned long chip,
                              unsigned long PlaneNum, unsigned long block, unsigned long page,const unsigned char data[], unsigned char* SpareTbl,unsigned long oob_len);	//SpareTbl将是包含MutiPlaneNum个T_MTDOOB缓冲的指针
...
typedef E_NANDERRORCODE (*fNand_ExReadSector)(T_PNANDFLASH nand, unsigned long chip,
                              unsigned long plane_num, unsigned long block, unsigned long page,unsigned char data[], unsigned char* spare_tbl,unsigned long oob_len, unsigned long page_num);//SpareTbl将是包含MutiPlaneNum个T_MTDOOB缓冲的指针
                              
typedef E_NANDERRORCODE (*fNand_ExWriteSector)(T_PNANDFLASH nand, unsigned long chip,
                              unsigned long plane_num, unsigned long block, unsigned long page,const unsigned char data[], unsigned char* spare_tbl,unsigned long oob_len, unsigned long page_num);    //SpareTbl将是包含MutiPlaneNum个T_MTDOOB缓冲的指针
