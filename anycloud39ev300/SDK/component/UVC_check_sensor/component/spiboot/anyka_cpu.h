...
#define IRQ_MASK_VEDIO_ENCODE_BIT			    (1 << 2)
 ...
 */ 
#define L2_BUF_BASE_ADDR                                (0x48000000)
#define L2_REG_BASE_ADDR                                (0x20140000)    
    /* registers *//*3910*/
#define L2_REG_DMA_ADDR                                 (L2_REG_BASE_ADDR+0x00)
#define L2_REG_DMA_CNT                                  (L2_REG_BASE_ADDR+0x40)
#define L2_REG_DMA_REQ                                  (L2_REG_BASE_ADDR+0x80)
#define L2_REG_FDMA_ADDR                                (L2_REG_BASE_ADDR+0x84)
#define L2_REG_CBUF_CFG                                 (L2_REG_BASE_ADDR+0x88)
#define L2_REG_UBUF_CFG                                 (L2_REG_BASE_ADDR+0x8c)
#define L2_REG_BUF_ASSIGN1                              (L2_REG_BASE_ADDR+0x90)
#define L2_REG_BUF_ASSIGN2                              (L2_REG_BASE_ADDR+0x94)
#define L2_REG_LDMA_CFG                                 (L2_REG_BASE_ADDR+0x98)
#define L2_REG_INT_EN                                   (L2_REG_BASE_ADDR+0x9c)
#define L2_REG_STATUS1                                  (L2_REG_BASE_ADDR+0xa0)
#define L2_REG_CRC                                      (L2_REG_BASE_ADDR+0xa4)
#define L2_REG_STATUS2                                  (L2_REG_BASE_ADDR+0xa8)
#define L2_REG_COLLISION                                (L2_REG_BASE_ADDR+0xAC)
/*3771*/
...
#define	UARTx_REG_BASE_ADDR(uart)		                (UART_MODULE_BASE_ADDR + (T_U32)(uart)*0x8000)
...
#define ADC_CFG_REG										(ADC_MODULE_BASE_ADDR + 0x0098)
#define ADC_SAMP_RATE_REG								(ADC_MODULE_BASE_ADDR + 0x0060)
#define ADC_CLK_CTR_REG									(ADC_MODULE_BASE_ADDR + 0x000C)
...
#define WATCHDOG_CFG1_REG					(CHIP_CONF_BASE_ADDR + 0x000000DC)     // WATCHDOG CFG1
#define WATCHDOG_CFG2_REG					(CHIP_CONF_BASE_ADDR + 0x000000E0)     // WATCHDOG CFG2
