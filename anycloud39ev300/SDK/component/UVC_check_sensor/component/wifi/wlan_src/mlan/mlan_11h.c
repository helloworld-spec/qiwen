                          ...
                          const t_void * pinfo_buf)
{
    ...
    memcpy( &pcmd_ptr->params.chan_rpt_req, pchan_rpt_req,
    ...
    if (wlan_11h_radar_detect_required(priv, pchan_rpt_req->chan_desc.chanNum)) {
        ...
        memset( &ptlv_basic->map, 0, sizeof(MeasRptBasicMap_t));
                                  ...
                                  IN t_bool is_adding_ie)
{
    ...
    memset( pioctl_req, 0x00, sizeof(mlan_ioctl_req));
    ...
    memset( pds_misc_cfg, 0x00, sizeof(mlan_ds_misc_cfg));
...
wlan_11h_add_dfs_timestamp(mlan_adapter * pmadapter, t_u8 repr, t_u8 channel)
{
    ...
    if (!pdfs_ts) {
        ...
        memset( (t_u8 *) pdfs_ts, 0, sizeof(wlan_dfs_timestamp_t));
...
wlan_11h_init(mlan_adapter * adapter)
{
    ...
    memset( pstate_rdh->priv_list, 0, sizeof(pstate_rdh->priv_list));
                            ...
                            pmlan_ioctl_req pioctl_req, t_u8 channel)
{
    ...
    if (ret) {
        ...
        memset( &chan_rpt_req, 0x00, sizeof(chan_rpt_req));
                          ...
                          const t_u8 * pelement)
{
    ...
    case CHANNEL_SWITCH_ANN:
        ...
        p11h_bss_info->sensed_11h = MTRUE;
        memcpy( &p11h_bss_info->chan_switch_ann, pelement,
               MIN((element_len + sizeof(IEEEtypes_Header_t)),
    ...
    case QUIET:
        ...
        p11h_bss_info->sensed_11h = MTRUE;
        memcpy( &p11h_bss_info->quiet, pelement,
               MIN((element_len + sizeof(IEEEtypes_Header_t)),
...
wlan_11h_radar_detected_handling(mlan_adapter * pmadapter)
{
    ...
    case RDH_CHK_INTFS:
        ...
        memset( pstate_rdh->priv_list, 0x00,
    ...
    case RDH_GET_INFO_CHANNEL:
        ...
        PRINTM(MCMD_D, "%s():  curr_chan=%d, new_chan=%d\n",
               __func__ , pstate_rdh->curr_channel, pstate_rdh->new_channel);
    ...
    case RDH_GET_INFO_BEACON_DTIM:
        ...
        if (pstate_rdh->priv_curr_idx < pstate_rdh->priv_list_count) {
            ...
            PRINTM(MCMD_D, "%s():  uap.bcn_pd=%d, uap.dtim_pd=%d\n",
                   __func__ , pmpriv->uap_state_chan_cb.beacon_period,
...
wlan_11h_dfs_event_preprocessing(mlan_adapter * pmadapter)
{
    ...
    case EVENT_RADAR_DETECTED:
        ...
        if (pmpriv) {
            ...
            memcpy( pmevbuf->pbuf + pmevbuf->data_offset,
