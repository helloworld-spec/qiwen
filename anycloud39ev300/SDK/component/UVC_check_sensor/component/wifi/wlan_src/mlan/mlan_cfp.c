...
const static country_code_mapping_t country_code_mapping[] = {
    {"US", 0x10, 0x10},         /* US FCC */
...
const static chan_freq_power_t channel_freq_power_US_BG[] = {
...
const static chan_freq_power_t channel_freq_power_EU_BG[] = {
...
const static chan_freq_power_t channel_freq_power_FR_BG[] = {
...
const static chan_freq_power_t channel_freq_power_JPN41_BG[] = {
...
/** Band: 'B/G', Region: Japan */
const static chan_freq_power_t channel_freq_power_JPN40_BG[] = {
    {14, 2484, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE}
};

/** Band: 'B/G', Region: Japan */
const static chan_freq_power_t channel_freq_power_JPNFE_BG[] = {
    {1, 2412, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {2, 2417, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {3, 2422, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {4, 2427, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
...
const static chan_freq_power_t channel_freq_power_BR_BG[] = {
...
const static chan_freq_power_t channel_freq_power_SPECIAL_BG[] = {
    {1, 2412, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {2, 2417, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {3, 2422, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
    {4, 2427, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
 ...
 */
const static cfp_table_t cfp_table_BG[] = {
    {
     0x01,                      /* Brazil */
     (chan_freq_power_t *)channel_freq_power_BR_BG,
...
const static chan_freq_power_t channel_freq_power_A[] = {
...
const static chan_freq_power_t channel_freq_power_CAN_A[] = {
    {36, 5180, WLAN_TX_PWR_US_DEFAULT, MFALSE},
    {40, 5200, WLAN_TX_PWR_US_DEFAULT, MFALSE},
    {44, 5220, WLAN_TX_PWR_US_DEFAULT, MFALSE},
    {48, 5240, WLAN_TX_PWR_US_DEFAULT, MFALSE},
...
const static chan_freq_power_t channel_freq_power_EU_A[] = {
...
/** Band: 'A', Region: Japan */
const static chan_freq_power_t channel_freq_power_JPN_A[] = {
...
/** Band: 'A', Region: China */
const static chan_freq_power_t channel_freq_power_CN_A[] = {
...
/** Band: 'A', NULL */
const static chan_freq_power_t channel_freq_power_NULL_A[] = {
0,
};

/** Band: 'A', Region: Germany */
const static chan_freq_power_t channel_freq_power_GRM_A[] = {
...
/** Band: 'A', Region: Spain */
const static chan_freq_power_t channel_freq_power_SPN0_A[] = {
...
/** Band: 'A', Region: Spain */
const static chan_freq_power_t channel_freq_power_SPN1_A[] = {
...
const static chan_freq_power_t channel_freq_power_SPN2_A[] = {
    {36, 5180, WLAN_TX_PWR_200MW, MFALSE},
    {40, 5200, WLAN_TX_PWR_200MW, MFALSE},
    {44, 5220, WLAN_TX_PWR_200MW, MFALSE},
    {48, 5240, WLAN_TX_PWR_200MW, MFALSE},
...
const static chan_freq_power_t channel_freq_power_SPN3_A[] = {
    {100, 5500, WLAN_TX_PWR_1000MW, MTRUE},
    {104, 5520, WLAN_TX_PWR_1000MW, MTRUE},
    {108, 5540, WLAN_TX_PWR_1000MW, MTRUE},
    {112, 5560, WLAN_TX_PWR_1000MW, MTRUE},
...
const static chan_freq_power_t channel_freq_power_AT_A[] = {
...
const static chan_freq_power_t channel_freq_power_BR1_A[] = {
...
/** Band: 'A', Region: Brazil */
const static chan_freq_power_t channel_freq_power_BR2_A[] = {
...
const static chan_freq_power_t channel_freq_power_RU_A[] = {
...
const static chan_freq_power_t channel_freq_power_low_band[] = {
...
const static chan_freq_power_t channel_freq_power_lower_middle_band[] = {
...
const static chan_freq_power_t channel_freq_power_upper_middle_band[] = {
...
const static chan_freq_power_t channel_freq_power_high_band[] = {
    {149, 5745, WLAN_TX_PWR_DEFAULT, MFALSE},
    {153, 5765, WLAN_TX_PWR_DEFAULT, MFALSE},
    {157, 5785, WLAN_TX_PWR_DEFAULT, MFALSE},
    {161, 5805, WLAN_TX_PWR_DEFAULT, MFALSE},
...
const static chan_freq_power_t channel_freq_power_low_high_band[] = {
    {36, 5180, WLAN_TX_PWR_DEFAULT, MFALSE},
    {40, 5200, WLAN_TX_PWR_DEFAULT, MFALSE},
    {44, 5220, WLAN_TX_PWR_DEFAULT, MFALSE},
    {48, 5240, WLAN_TX_PWR_DEFAULT, MFALSE},
 ...
 * The 5GHz CFP tables
 */
const static cfp_table_t cfp_table_A[] = {
 ...
 */
const t_u16 region_code_index[MRVDRV_MAX_REGION_CODE] =
    { 0x10, 0x20, 0x30, 0x32, 0x40, 0x41, 0x50, 0xfe, 0xff };

/** The table to keep CFP code for BG */
const t_u16 cfp_code_index_bg[MRVDRV_MAX_CFP_CODE_BG] = { 0};

/** The table to keep CFP code for A */
const t_u16 cfp_code_index_a[MRVDRV_MAX_CFP_CODE_A] = { 0x1, 0x2, 0x3, 0x4, 0x5 };

/**
 * The rates supported for ad-hoc B mode
 */
const t_u8 AdhocRates_B[B_SUPPORTED_RATES] = { 0x82, 0x84, 0x8b, 0x96, 0 };

/**
 * The rates supported for ad-hoc G mode
 */
const t_u8 AdhocRates_G[G_SUPPORTED_RATES] =
    { 0x8c, 0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0 };

/**
 * The rates supported for ad-hoc BG mode
 */
const t_u8 AdhocRates_BG[BG_SUPPORTED_RATES] =
 ...
 */
const t_u8 AdhocRates_A[A_SUPPORTED_RATES] =
    { 0x8c, 0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0 };

/**
 * The rates supported in A mode (used for BAND_A)
 */
const t_u8 SupportedRates_A[A_SUPPORTED_RATES] =
 ...
 */
const t_u16 WlanDataRates[WLAN_SUPPORTED_RATES_EXT] =
 ...
 */
const t_u8 SupportedRates_B[B_SUPPORTED_RATES] = { 0x02, 0x04, 0x0b, 0x16, 0 };

/**
 * The rates supported in G mode (BAND_G, BAND_G|BAND_GN)
 */
const t_u8 SupportedRates_G[G_SUPPORTED_RATES] =
    { 0x0c, 0x12, 0x18, 0x24, 0x30, 0x48, 0x60, 0x6c, 0 };

/**
 * The rates supported in BG mode (BAND_B|BAND_G, BAND_B|BAND_G|BAND_GN)
 */
const t_u8 SupportedRates_BG[BG_SUPPORTED_RATES] =
 ...
 */
const t_u8 SupportedRates_N[N_SUPPORTED_RATES] = { 0x02, 0x04, 0 };
                      ...
                      chan_freq_power_t * cfp_src, t_u8 num_cfp_src)
{
    ...
    //for (i = 0; i < num_cfp; i++)
    //  memset( &cfp[i].dynamic, 0x00, sizeof(cfp_dyn_t));

    /* copy dynamic entries from source where channels match */
    if (cfp_src) {
		for (i = 0; i < num_cfp; i++)	//edit by lkc
			memset( &cfp[i].dynamic, 0x00, sizeof(cfp_dyn_t));
                                   ...
                                   t_u8 * cfp_bg, t_u8 * cfp_a)
{
    ...
    for (i = 0; i < NELEMENTS(country_code_mapping); i++) {
        if (!memcmp( country_code_mapping[i].country_code,
...
wlan_data_rate_to_index(pmlan_adapter pmadapter, t_u32 rate)
{
    ...
    ENTER();
    if (rate)
        if ((ptr = wlan_memchr(pmadapter, (void*)WlanDataRates, (t_u8) rate,
                         ...
                         t_u8 config_bands, WLAN_802_11_RATES rates)
{
    ...
    if (bss_mode == MLAN_BSS_MODE_INFRA) {
        ...
        case BAND_B:
            ...
            k = wlan_copy_rates(rates, k, (void*)SupportedRates_B,
                                sizeof(SupportedRates_B));
            break;
        case BAND_G:
        case BAND_G | BAND_GN:
            PRINTM(MINFO, "Infra band=%d SupportedRates_G\n", config_bands);
            k = wlan_copy_rates(rates, k, (void*)SupportedRates_G,
        ...
        case BAND_B | BAND_G | BAND_GN:
            ...
            if (pmpriv->bss_type == MLAN_BSS_TYPE_WIFIDIRECT)
                ...
                k = wlan_copy_rates(rates, k, (void*)SupportedRates_BG,
        ...
        case BAND_A | BAND_G:
            ...
            k = wlan_copy_rates(rates, k, (void*)SupportedRates_A,
        ...
        case BAND_GN:
            ...
            k = wlan_copy_rates(rates, k, (void*)SupportedRates_N,
        ...
        case BAND_B:
            ...
            k = wlan_copy_rates(rates, k, (void*)AdhocRates_B, sizeof(AdhocRates_B));
            break;
        case BAND_G:
        case BAND_G | BAND_GN:
            PRINTM(MINFO, "Band: Adhoc G only\n");
            k = wlan_copy_rates(rates, k, (void*)AdhocRates_G, sizeof(AdhocRates_G));
            break;
        case BAND_B | BAND_G:
        case BAND_B | BAND_G | BAND_GN:
            PRINTM(MINFO, "Band: Adhoc BG\n");
            k = wlan_copy_rates(rates, k, (void*)AdhocRates_BG, sizeof(AdhocRates_BG));
            break;
        case BAND_A:
        case BAND_AN:
        case BAND_A | BAND_AN:
            ...
            k = wlan_copy_rates(rates, k, (void*)AdhocRates_A, sizeof(AdhocRates_A));
			#endif
            break;
        }
    }
...
wlan_set_regiontable(mlan_private * pmpriv, t_u8 region, t_u8 band)
{
    ...
    memcpy( region_chan_old, pmadapter->region_channel,
           sizeof(pmadapter->region_channel));
    memset( pmadapter->region_channel, 0,
           sizeof(pmadapter->region_channel));
