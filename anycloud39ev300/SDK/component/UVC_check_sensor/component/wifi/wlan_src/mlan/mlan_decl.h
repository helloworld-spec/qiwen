...
#define MLAN_RELEASE_VERSION		"336"
...
#define MLAN_MAX_BSS_NUM         2	//(16) wmj set 3 to 2

/** NET IP alignment */
#define MLAN_NET_IP_ALIGN        0

/** DMA alignment */
#define DMA_ALIGNMENT            64//64
/** max size of TxPD */
...
typedef enum _mlan_error_code
{
    ...
    MLAN_ERROR_PKT_SIZE_INVALID = 0x40000001,//0x80000001,
...
typedef enum _mlan_event_id
{
    ...
    MLAN_EVENT_ID_DRV_CONNECTED = 0x40000001,//0x80000001,
