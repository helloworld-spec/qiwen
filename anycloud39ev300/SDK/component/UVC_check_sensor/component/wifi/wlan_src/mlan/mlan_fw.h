...
extern const t_u8 SupportedRates_B[B_SUPPORTED_RATES];
extern const t_u8 SupportedRates_G[G_SUPPORTED_RATES];
extern const t_u8 SupportedRates_BG[BG_SUPPORTED_RATES];
extern const t_u8 SupportedRates_A[A_SUPPORTED_RATES];
extern const t_u8 SupportedRates_N[N_SUPPORTED_RATES];
extern const t_u8 AdhocRates_G[G_SUPPORTED_RATES];
extern const t_u8 AdhocRates_B[B_SUPPORTED_RATES];
extern const t_u8 AdhocRates_BG[BG_SUPPORTED_RATES];
extern const t_u8 AdhocRates_A[A_SUPPORTED_RATES];
...
#define MRVDRV_NUM_OF_CMD_BUFFER       16//20
...
/** ChanBandParamSet_t */
typedef MLAN_PACK_START struct _ChanBandParamSet_t
{
    /** Channel scan parameter : Radio type */
    t_u8 radio_type;
    /** Channel number */
...
/** bf global args */
typedef MLAN_PACK_START struct _bf_global_cfg_args
{
...
typedef MLAN_PACK_START struct _bf_peer_args
{
    /** Peer MAC address */
    t_u8 peer_mac[MLAN_MAC_ADDR_LENGTH];
    /** Reserved */
