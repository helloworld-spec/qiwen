...
extern const t_u16 region_code_index[MRVDRV_MAX_REGION_CODE];
/** The table to keep CFP code for BG */
extern const t_u16 cfp_code_index_bg[MRVDRV_MAX_CFP_CODE_BG];
/** The table to keep CFP code for A */
extern const t_u16 cfp_code_index_a[MRVDRV_MAX_CFP_CODE_A];
