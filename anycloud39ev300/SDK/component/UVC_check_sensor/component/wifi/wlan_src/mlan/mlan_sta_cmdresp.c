                          ...
                          IN mlan_ioctl_req * pioctl_buf)
{
    ...
    if (pioctl_buf != MNULL) {
        ...
        memset( &pget_info->param.signal, 0,
...
{
    t_u16 length = 0;
    t_s8 max_power = 0xff, min_power = 0xff;
                            ...
                            IN mlan_ioctl_req * pioctl_buf)
{
    ...
    memcpy( pmpriv->curr_addr, pmac_addr->mac_addr,
...
#define WAPI_KEY_SIZE 32
            ...
            case KEY_TYPE_ID_WAPI:
                ...
                memcpy( sec->param.encrypt_key.key_material,
                       &pkey->key_param_set.key[2],
                       sec->param.encrypt_key.key_len);
                memcpy( sec->param.encrypt_key.pn,
        ...
        if (action == HostCmd_ACT_GEN_GET) {
            ...
            while (tlv_buf_len > 0) {
                ...
                case TLV_TYPE_SSID:
                    ...
                    memcpy( sec->param.passphrase.ssid.ssid,
                ...
                case TLV_TYPE_BSSID:
                    ...
                    memcpy( &sec->param.passphrase.bssid,
                                ...
                                IN HostCmd_DS_COMMAND * resp)
{
    ...
    if (!memcmp
        (pibss_coal_resp->bssid, zero_mac,
         MLAN_MAC_ADDR_LENGTH)) {
    ...
    if (pioctl_buf && (pioctl_buf->action == MLAN_ACT_GET)) {
        ...
        user_data->user_data_length = MIN(MAX_OTP_USER_DATA_LEN,
                                          wlan_le16_to_cpu(cmd_user_data->
                                                           user_data_length));
        memcpy( user_data->user_data, cmd_user_data->user_data,
