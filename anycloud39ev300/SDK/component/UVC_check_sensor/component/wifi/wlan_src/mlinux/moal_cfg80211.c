...
#define RATETAB_ENT(_rate, _hw_value, _flags) {(_flags),(_rate),(_hw_value), 0}


/* Table 6 in section 3.2.1.1 */
const struct ieee80211_rate cfg80211_rates[] = {
	RATETAB_ENT(/*.bitrate =*/ 10,/*.hw_value =*/ 2,0),
    RATETAB_ENT(/*.bitrate =*/ 20,/*.hw_value =*/ 4,0),
    RATETAB_ENT(/*.bitrate =*/ 55,/*.hw_value =*/ 11,0),
    RATETAB_ENT(/*.bitrate =*/ 110,/*.hw_value =*/ 22,0),
    RATETAB_ENT(/*.bitrate =*/ 220,/*.hw_value =*/ 44,0),
    RATETAB_ENT(/*.bitrate =*/ 60,/*.hw_value =*/ 12,0),
    RATETAB_ENT(/*.bitrate =*/ 90,/*.hw_value =*/ 18,0),
    RATETAB_ENT(/*.bitrate =*/ 120,/*.hw_value =*/ 24,0),
    RATETAB_ENT(/*.bitrate =*/ 180,/*.hw_value =*/ 36,0),
    RATETAB_ENT(/*.bitrate =*/ 240,/*.hw_value =*/ 48,0),
    RATETAB_ENT(/*.bitrate =*/ 360,/*.hw_value =*/ 72,0),
    RATETAB_ENT(/*.bitrate =*/ 480,/*.hw_value =*/ 96,0),
    RATETAB_ENT(/*.bitrate =*/ 540,/*.hw_value =*/ 108,0),
    RATETAB_ENT(/*.bitrate =*/ 720,/*.hw_value =*/ 144,0),
};

#define CHAN2G(_freq, _channel, _flags) {IEEE80211_BAND_2GHZ,(_freq),(_channel),(_flags),0,/*30*/20,(bool)0,0,0,0}

/** Channel definitions for 2 GHz to be advertised to cfg80211 */
const struct ieee80211_channel cfg80211_channels_2ghz[] = {
    CHAN2G(/*.center_freq =*/ 2412,/*.hw_value =*/ 1,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2417,/*.hw_value =*/ 2,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2422,/*.hw_value =*/ 3,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2427,/*.hw_value =*/ 4,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2432,/*.hw_value =*/ 5,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2437,/*.hw_value =*/ 6,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2442,/*.hw_value =*/ 7,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2447,/*.hw_value =*/ 8,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2452,/*.hw_value =*/ 9,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2457,/*.hw_value =*/ 10,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2462,/*.hw_value =*/ 11,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2467,/*.hw_value =*/ 12,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2472,/*.hw_value =*/ 13,/*._flags =*/ 0),
    CHAN2G(/*.center_freq =*/ 2484,/*.hw_value =*/ 14,/*._flags =*/ 0),
};

#define CHAN5G(_freq, _channel, _flags) {IEEE80211_BAND_5GHZ,(_freq),(_channel),(_flags),0,/*30*/20,(bool)0,0,0,0}
...
const struct ieee80211_channel cfg80211_channels_5ghz[] = {
    CHAN5G(/*.center_freq =*/ 5040,/*.hw_value =*/ 8,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5060,/*.hw_value =*/ 12,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5080,/*.hw_value =*/ 16,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5170,/*.hw_value =*/ 34,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5190,/*.hw_value =*/ 38,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5210,/*.hw_value =*/ 42,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5230,/*.hw_value =*/ 46,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5180,/*.hw_value =*/ 36,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5200,/*.hw_value =*/ 40,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5220,/*.hw_value =*/ 44,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5240,/*.hw_value =*/ 48,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5260,/*.hw_value =*/ 52,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5280,/*.hw_value =*/ 56,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5300,/*.hw_value =*/ 60,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5320,/*.hw_value =*/ 64,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5500,/*.hw_value =*/ 100,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5520,/*.hw_value =*/ 104,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5540,/*.hw_value =*/ 108,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5560,/*.hw_value =*/ 112,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5580,/*.hw_value =*/ 116,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5600,/*.hw_value =*/ 120,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5620,/*.hw_value =*/ 124,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5640,/*.hw_value =*/ 128,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5660,/*.hw_value =*/ 132,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5680,/*.hw_value =*/ 136,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5700,/*.hw_value =*/ 140,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5745,/*.hw_value =*/ 149,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5765,/*.hw_value =*/ 153,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5785,/*.hw_value =*/ 157,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5805,/*.hw_value =*/ 161,/*.max_power =*/ 0),
    CHAN5G(/*.center_freq =*/ 5825,/*.hw_value =*/ 165,/*.max_power =*/ 0),
};
...
struct ieee80211_supported_band cfg80211_band_2ghz = {
    /*.channels = */(struct ieee80211_channel*)cfg80211_channels_2ghz,
    /*.bitrates = */(struct ieee80211_rate*)cfg80211_rates,
    IEEE80211_BAND_2GHZ,
    /*.n_channels = */ARRAY_SIZE(cfg80211_channels_2ghz, struct ieee80211_channel),
    /*.n_bitrates = */ARRAY_SIZE(cfg80211_rates, struct ieee80211_rate),
...
struct ieee80211_supported_band cfg80211_band_5ghz = {
    /*.channels = */(struct ieee80211_channel*)cfg80211_channels_5ghz,
    /*.bitrates = */(struct ieee80211_rate*)cfg80211_rates + 5,
    IEEE80211_BAND_5GHZ,
    /*.n_channels = */ARRAY_SIZE(cfg80211_channels_5ghz, struct ieee80211_channel),
    /*.n_bitrates = */ARRAY_SIZE(cfg80211_rates, struct ieee80211_rate) - 5,
};
#endif
...
{
    return (void *) (*(unsigned long *) (wiphy->priv));
}
                                  ...
                                  struct vif_params *params)
{
    ...
    case NL80211_IFTYPE_STATION:
        ...
        if (priv->bss_type == MLAN_BSS_TYPE_WIFIDIRECT
            ...
            if (priv->phandle->is_go_timer_set) {
                woal_stop_timer(&priv->phandle->go_timer);
    ...
    case NL80211_IFTYPE_P2P_GO:
        if (priv->bss_type == MLAN_BSS_TYPE_WIFIDIRECT) {
            ...
            woal_start_timer(&priv->phandle->go_timer, MOAL_TIMER_10S);
        }
...
#endif
	//edit by lck
    int frag_thr = /*wiphy->frag_threshold*/MLAN_FRAG_MIN_VALUE;
    int rts_thr = /*wiphy->frag_threshold*/MLAN_RTS_MIN_VALUE;
    int retry = /*wiphy->retry_long*/MLAN_TX_RETRY_MAX;
...
#define PACKET_ADDR4_POS		(2 + 2 + 6 + 6 + 6 + 2)
    ...
    case MLAN_STATUS_PENDING:
        ...
        //wmj- 20170309 main_process has been call in interrupt ruting
        ...
        /* delay 20ms to guarantee the packet has been already tx'ed becuase if 
           ...
           frame tx */
      //wmj- no call cfg80211_mgmt_tx_status no delay needed
      //mdelay(20);
                            ...
                            size_t probereq_ies_len, t_u16 mask)
{
    ...
    if (mask & MGMT_MASK_BEACON) {
        if ((beacon_ies_data = kmalloc(sizeof(custom_ie), GFP_KERNEL)) == 0) {
            ret = -ENOMEM;
            goto done;
        }
    }
    ...
    if (mask & MGMT_MASK_PROBE_RESP) {
        ...
        if (proberesp_ies_len || (!proberesp_ies_len && !beacon_ies_len)) {
            if ((proberesp_ies_data = kmalloc(sizeof(custom_ie), GFP_KERNEL)) == 0) {
                ret = -ENOMEM;
                goto done;
            }
        }
    ...
    if (mask & MGMT_MASK_ASSOC_RESP) {
        ...
        if (assocresp_ies_len || (!assocresp_ies_len && !beacon_ies_len)) {
            if ((assocresp_ies_data = kmalloc(sizeof(custom_ie), GFP_KERNEL)) == 0) {
                ret = -ENOMEM;
                goto done;
            }
        }
    ...
    if (mask & MGMT_MASK_PROBE_REQ) {
        if ((probereq_ies_data = kmalloc(sizeof(custom_ie), GFP_KERNEL)) == 0) {
            ret = -ENOMEM;
            goto done;
        }
    }
