...
//wmj- this ID used for get max tx_pending 
...
/*wmj+ for get tx_pending packet*/
#define UAP_GET_TX_PENDING    		(SIOCDEVPRIVATE + 8)
/*wmj+ for set MAX tx_pending limit*/
#define UAP_SET_MAX_TX_PENDING    		(SIOCDEVPRIVATE + 9)
/*wmj+ for get MAX tx_pending limit*/
#define UAP_GET_MAX_TX_PENDING    		(SIOCDEVPRIVATE + 10)
#endif 
//wmj<<
...
typedef struct __snmp_mib_para
{
    /** subcmd */
    t_u32 subcmd;
    /** Set/Get */
...
#define SNMP_MIB_PARAM_SIZE	(sizeof(_snmp_mib_param))
...
typedef struct __domain_info_param
{
    /** subcmd */
    t_u32 subcmd;
    /** Set/Get */
...
#define SNMP_INFO_PARAM_SIZE	(sizeof(domain_info_param))
