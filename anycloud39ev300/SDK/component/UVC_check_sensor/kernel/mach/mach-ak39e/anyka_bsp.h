...
#ifdef AKOS
#define TimerHISR               (0x1e800)  //0xC800
...
#define IRQ_MODE_STACK_SIZE     (0x20000)
#define FIQ_MODE_STACK_SIZE     (0x20)  /* if has FIQ, enlarge it */
#define ABORT_MODE_STACK_SIZE   (0x2000)
#define UNDEF_MODE_STACK_SIZE      (0x2000)
