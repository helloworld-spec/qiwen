...
/**
 * ak_alarm_interval_time_set - set report_interval && detect_interval for  ak alarm 
...
/**
 * ak_alarm_ratios_set - set  one type of ak alarm sensitivity
...
/**
 * ak_alarm_start - stop one type of ak alarm 
