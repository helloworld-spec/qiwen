...
#define AUDIOCODEC_VERSION		(T_U8 *)"AudioCodec Version V1.15.00_svn5145_akv200_Alib"
#ifdef AUDIOLIB_LINK_AUTOMATIC
#define AUDIOCODEC_VERSION_STRING (AUDIOCODEC_VERSION " AUTOLINK")
#else
#define AUDIOCODEC_VERSION_STRING AUDIOCODEC_VERSION
#endif
/** @} */
...
typedef struct
{
	...
	union{
        ...
        struct{
            T_BOOL cbr;
			T_BOOL dtx_disable;
            T_U32 bitrate;//target bitrate. 0: auto set.
