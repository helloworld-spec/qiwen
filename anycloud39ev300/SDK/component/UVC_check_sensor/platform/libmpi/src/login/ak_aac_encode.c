...
static unsigned char audio_aac_encode_cb_delay(unsigned long ticks)
{
	ak_sleep_ms(ticks);
	return 1;
}
/**
 * @brief  login  aac  encode  type
 * @author Pyy
 * @date   2017-05-31
 * @return 
 * @retval 
 */
void ak_login_aac_encode(void)
{
		...
		plogInput.cb.delay = audio_aac_encode_cb_delay;
