...
static unsigned char audio_amr_dencode_cb_delay(unsigned long ticks)
{
	ak_sleep_ms(ticks);	
	return 1;
}
/**
 * @brief  login  amr  decode  type
 * @author Pyy
 * @date   2017-05-31
 * @return 
 * @retval 
 */
void ak_login_amr_decode(void)
{
		...
		plogInput.cb.delay = audio_amr_dencode_cb_delay;
