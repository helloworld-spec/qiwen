// GammaLargeDlg.cpp : implementation file
//

#include "stdafx.h"
#include "ispctrl_tool.h"
#include "GammaLargeDlg.h"
#include "NetCtrl.h"
...
CGammaLargeDlg::CGammaLargeDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CGammaLargeDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CGammaLargeDlg)
...
void CGammaLargeDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGammaLargeDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CGammaLargeDlg, CDialog)
	//{{AFX_MSG_MAP(CGammaLargeDlg)
	ON_WM_CLOSE()
...
/////////////////////////////////////////////////////////////////////////////
// CGammaLargeDlg message handlers
BOOL CGammaLargeDlg::OnInitDialog()
{
...
int CGammaLargeDlg::SetGammaEnable(BOOL bEnable)
{
	m_bGammaEnable = bEnable;
	return 0;
}

int CGammaLargeDlg::GetPageInfoSt(int & nPageID, void * pPageInfoSt, int & nStLen)
{
...
int CGammaLargeDlg::SetPageInfoSt(void * pPageInfoSt, int nStLen)
{
	if ((pPageInfoSt == NULL) || (nStLen != sizeof(AK_ISP_INIT_GAMMA))) return -1;
...
void CGammaLargeDlg::OnButtonOk() 
{
...
void CGammaLargeDlg::OnButtonCancel() 
{
	// TODO: Add your control notification handler code here
	CDialog::OnCancel();
	OnClose();
