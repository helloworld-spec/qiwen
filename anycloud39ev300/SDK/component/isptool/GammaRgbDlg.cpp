// GammaRgbDlg.cpp : implementation file
//

#include "stdafx.h"
#include "ISPCTRL_TOOL.h"
#include "GammaRgbDlg.h"
#include "NetCtrl.h"
...
CGammaRgbDlg::CGammaRgbDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CGammaRgbDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CGammaRgbDlg)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CGammaRgbDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CGammaRgbDlg)

	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CGammaRgbDlg, CDialog)
	//{{AFX_MSG_MAP(CGammaRgbDlg)
	ON_WM_CLOSE()
...
/////////////////////////////////////////////////////////////////////////////
// CGammaRgbDlg message handlers
BOOL CGammaRgbDlg::OnInitDialog()
{
...
void CGammaRgbDlg::OnButtonGet() 
{
	// TODO: Add your control notification handler code here
	if (NULL == m_pMessageWnd) return;
	CBasePage::SendPageMessage(m_pMessageWnd, WM_GET_ISP_INFO, DIALOG_GAMMA_RGB, 0);
}

void CGammaRgbDlg::OnButtonSet() 
{
	// TODO: Add your control notification handler code here
	if (NULL == m_pMessageWnd) return;
	CBasePage::SendPageMessage(m_pMessageWnd, WM_SUBMISSION, DIALOG_GAMMA_RGB, 0);
}

int CGammaRgbDlg::SetGammaEnable(BOOL bEnable)
{
	m_bGammaEnable = bEnable;
	return 0;
}

int CGammaRgbDlg::GetPageInfoSt(int & nPageID, void * pPageInfoSt, int & nStLen)
{
...
int CGammaRgbDlg::SetPageInfoSt_level(void * pPageInfoSt, int nStLen)
{
	if ((pPageInfoSt == NULL) || (nStLen != sizeof(AK_ISP_INIT_GAMMA))) return -1;
...
int CGammaRgbDlg::SetPageInfoSt(void * pPageInfoSt, int nStLen)
{
	if ((pPageInfoSt == NULL) || (nStLen != sizeof(AK_ISP_INIT_GAMMA))) return -1;
