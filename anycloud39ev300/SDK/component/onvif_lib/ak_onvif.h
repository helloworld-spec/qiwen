...
int GetVideoPara(int *fps, int *bitrate, int *quality, int *flage, int *width, int *height, int main_small);
...
int SetVideoPara(int fps, int bitrate, int quality, int width, int height, int flage );
...
int IniReadString (const char *section, const char *indent, const char *defaultresult, char *result, int resultlen, char *inifilename);
...
int IniReadInteger (const char *section, const char *indent, int defaultresult, char *inifilename);
...
int IniWriteString (const char *section, const char *indent, const char *value, char *inifilename);
...
int IniWriteInteger (const char *section, const char *indent, int value, char *inifilename);
