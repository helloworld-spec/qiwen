...
#define VERSION                      "IPCAM-ONVIF-V1.1.0.3"
//#define OLD_IRCUT
...
#define SEND_BUF_SIZE                (320*1024)//(128*1024)//(512*1024)
...
static inline int thread_set_name(const char *name)
{
	if (!name) {
		printf("invalid name\n");
	}
