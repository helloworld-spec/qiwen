...
/*** for aspen 3s */
#define ANALOG_CTRL_REG1                                (ADC_MODULE_BASE_ADDR + 0x9C)
#define ANALOG_CTRL_REG2                                (ADC_MODULE_BASE_ADDR + 0xA0)
#define ANALOG_CTRL_REG3                                (ADC_MODULE_BASE_ADDR + 0xA4)
 ...
 */
//gpio direction
#define GPIO_MODULE_BASE_ADDR                           0x20170000   // 0x08000000      // GPIO registers
