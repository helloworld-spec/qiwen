...
#define DEBUG_LL_STATE 0 // cdh:0	/* Link local state machine changes */
#define DEBUG_DEV_PKT 0 // cdh:0		/* Packets or info directed to the device */
#define DEBUG_NET_PKT 0 // cdh:0		/* Packets on info on the network at large */
#define DEBUG_INT_STATE 0 // cdh:0	/* Internal network state changes */
...
#ifdef CONFIG_SYS_RX_ETH_BUFFER  // cdh:CONFIG_SYS_RX_ETH_BUFFER = 256
# define PKTBUFSRX	CONFIG_SYS_RX_ETH_BUFFER
#else
# define PKTBUFSRX	1500 //1400 // 256 // 16 // cdh:old 4
#endif

#define PKTALIGN	ARCH_DMA_MINALIGN  // cdh:ARCH_DMA_MINALIGN = 64
...
{
	//printf("cdh:NetSendPacket pkt:0x%x, len:%d\n", pkt, len);
...
{
#ifdef CONFIG_NETCONSOLE  // cdh:CONFIG_NETCONSOLE=n
