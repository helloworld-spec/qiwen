...
struct ak39_codec_platform_data ak39_codec_pdata =
{
	...
	.hpdet_irq            = IRQ_GPIO_52,
	.linindet_irq         = IRQ_GPIO_53,
	.bIsHPmuteUsed        = 0,
...
static struct aksensor_camera_info ak_soc_camera_info = {
	...
	.pin_pwdn = AK_GPIO_40,		//initialize GPIO for the power of camera.
	.pin_reset = AK_GPIO_39,
	.link = {
		.bus_id = 39,
		.power = NULL,
...
MACHINE_START(AK39XX, "Cloud39E_AK3916E128PIN_MNBD_V1.0.0")
/* Maintainer: */
	.atag_offset = 0x100,
	.fixup = NULL,
	.map_io = ak39_map_io,
