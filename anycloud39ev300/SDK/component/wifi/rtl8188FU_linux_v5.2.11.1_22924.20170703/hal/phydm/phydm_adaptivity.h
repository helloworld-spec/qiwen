...
#define ADAPTIVITY_VERSION	"9.5.2"	/*20170412 changed by Kevin, change th_l2h_ini setting for 5G: v2.1.0*/
...
struct _ADAPTIVITY_STATISTICS {
	...
	u16			igi_up_bound_lmt_cnt;	/*When igi_up_bound_lmt_cnt !=0, limit IGI upper bound to "adaptivity_igi_upper"*/
