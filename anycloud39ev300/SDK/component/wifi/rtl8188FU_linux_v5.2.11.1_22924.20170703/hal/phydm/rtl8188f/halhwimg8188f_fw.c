...
#include "../phydm_precomp.h"
	...
	#include "../../rtl8188f/hal8188f_fw.h"
#endif
...
u32 array_length_mp_8188f_fw_ap = 17584;
...
)
{
	...
	*((SIZE_PTR *)p_firmware) = (SIZE_PTR)array_mp_8188f_fw_ap;
#else
	odm_move_memory(p_dm_odm, p_firmware, array_mp_8188f_fw_ap, array_length_mp_8188f_fw_ap);
#endif
	*p_firmware_size = array_length_mp_8188f_fw_ap;
}
...
u32 array_length_mp_8188f_fw_nic = 23242;
...
{
#if (DM_ODM_SUPPORT_TYPE & (ODM_CE))
	*((SIZE_PTR *)p_firmware) = (SIZE_PTR)array_mp_8188f_fw_nic;
#else
	odm_move_memory(p_dm_odm, p_firmware, array_mp_8188f_fw_nic, array_length_mp_8188f_fw_nic);
#endif
	*p_firmware_size = array_length_mp_8188f_fw_nic;
}
...
u32 array_length_mp_8188f_fw_wowlan = 21148;
...
{
#if (DM_ODM_SUPPORT_TYPE & (ODM_CE))
	*((SIZE_PTR *)p_firmware) = (SIZE_PTR)array_mp_8188f_fw_wowlan;
#else
	odm_move_memory(p_dm_odm, p_firmware, array_mp_8188f_fw_wowlan, array_length_mp_8188f_fw_wowlan);
#endif
	*p_firmware_size = array_length_mp_8188f_fw_wowlan;
}
