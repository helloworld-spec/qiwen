...
)
{
	...
	odm_config_rf_reg_8188f(p_dm_odm, addr, data, ODM_RF_PATH_A, addr | maskfor_phy_set);
...
)
{
	...
	odm_config_rf_reg_8188f(p_dm_odm, addr, data, ODM_RF_PATH_B, addr | maskfor_phy_set);
