...
void rtl8188f_req_txrpt_cmd(PADAPTER padapter, u8 macid)
{
	...
	SET_8188F_H2CCMD_TXREP_PARM_STA1(u1H2CApReqRptParm, macid);
	SET_8188F_H2CCMD_TXREP_PARM_STA2(u1H2CApReqRptParm, 0xff);
	SET_8188F_H2CCMD_TXREP_PARM_RTY(u1H2CApReqRptParm, 0x00);
	FillH2CCmd8188F(padapter, H2C_AP_REQ_TXRPT, H2C_AP_REQ_TXRPT_LEN, u1H2CApReqRptParm);
	SET_8188F_H2CCMD_TXREP_PARM_RTY(u1H2CApReqRptParm, 0x02);
	FillH2CCmd8188F(padapter, H2C_AP_REQ_TXRPT, H2C_AP_REQ_TXRPT_LEN, u1H2CApReqRptParm);
}
