...
#include "ssv_ieee80211_radiotap.h"
...
/* TODO(aaron): start the struct vht_group_notif in kernel 4.6 */		
...
/* TODO(aaron): start v3.17 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3,17,0)
		ndev = alloc_netdev_mqs(size + txq_size,
					name, name_assign_type, if_setup, txqs, 1);
#else
