#ifndef _SSV_NET_CFG80211_H
#define _SSV_NET_CFG80211_H
#if 0
/*
...
#include "ssv_nl80211.h"
#include <linux/if_ether.h>
//#include <linux/ieee80211.h>
#include "ssv_ieee80211.h"
#include <linux/net.h>
...
{
	return read_pnet((struct net * const*)&wiphy->_net);
}

static inline void wiphy_net_set(struct wiphy *wiphy, struct net *net)
{
	write_pnet((struct net **)&wiphy->_net, net);
}
