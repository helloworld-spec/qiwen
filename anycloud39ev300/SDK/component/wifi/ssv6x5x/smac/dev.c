...
//                msleep(800);
            ...
            if (sc->hw_chan == chan->hw_value){
                if ((sc->hw_chan_type == NL80211_CHAN_HT40MINUS)||
                    (sc->hw_chan_type == NL80211_CHAN_HT40PLUS)){
                  
                    if (channel_type < NL80211_CHAN_HT40MINUS){
                        sc->sc_flags |= SC_OP_FORCE_HT20;
                        printk("Set force HT20 for change bandwith\n");
                    } else { 
                        sc->sc_flags &= ~SC_OP_FORCE_HT20;
                        printk("clear force HT20 for change bandwith\n");
                    }
