...
#ifndef __AG101_REGS_H__
#define __AG101_REGS_H__
 ...
 ****************************************************************************/
        ...
        #define IRQ_PM_VECTOR                   12      // performance monitor
 ...
 * AHBC - AG101 AHB
 ****************************************************************************/
#define AHBC_BASE			0x90100000 /* Device base address */
 ...
 * SMC - AG101 AHB
 ****************************************************************************/
#define SMC_BASE			0x90200000 /* Device base address */


/*****************************************************************************
 * SDRAMC - AG101 AHB
 ****************************************************************************/
#define SDRAMC_BASE			0x90300000 /* Device base address */


/*****************************************************************************
 * DMAC - AG101 AHB
 ****************************************************************************/
#define DMAC_BASE			0x90400000 /* Device base address */
 ...
 ****************************************************************************/
#define APBBR_BASE			0x90500000 /* Device base address */
 ...
 * LCDC - AG101 AHB
 ****************************************************************************/
#define LCDC_BASE			0x90600000 /* Device base address */
 ...
 * MAC - AG101 AHB
 ****************************************************************************/
#define MAC_BASE			0x90900000 /* Device base address */
 ...
 * USB - AG101 AHB
 ****************************************************************************/
#define USBC_BASE			0x90b00000 /* Device base address */

/*****************************************************************************
 * PMU - AG101 Core APB
 ****************************************************************************/
#define PMU_BASE			0x98100000 /* Device base address */
 ...
 ****************************************************************************/
#define TMRC_BASE			0x98400000 /* Device base address */
 ...
 * WDT - AG101 Core APB
 ****************************************************************************/
#define WDTC_BASE			0x98500000 /* Device base address */


/*****************************************************************************
 * RTC - AG101 Core APB
 ****************************************************************************/
#define RTC_BASE			0x98600000 /* Device base address */
 ...
 * GPIO - AG101 Core APB
 ****************************************************************************/
#define GPIOC_BASE			0x98700000 /* Device base address */
 ...
 * INTC - AG101 Core APB
 ****************************************************************************/
#define INTC_BASE			0x98800000 /* Device base address */
 ...
 * I2C - AG101 Core APB
 ****************************************************************************/
#define I2C_BASE			0x98a00000 /* Device base address */


/*****************************************************************************
 * SSP - AG101 DMA APB (SSP1)
 ****************************************************************************/
#define SSPC_BASE			0x98b00000 /* (SSP1) Device base address */
 ...
 * CFC - AG101 DMA APB
 ****************************************************************************/
#define CFC_BASE			0x98d00000 /* Device base address */
 ...
 ****************************************************************************/
#define SDC_BASE			0x98e00000 /* Device base address */
 ...
 * PWM - AG101 Core APB
 ****************************************************************************/
#define PWM_BASE			0x99100000 /* Device base address */


/*****************************************************************************
 * I2S/AC97 - AG101 DMA APB (SSP2)
 ****************************************************************************/
#define I2SAC97_BASE			0x99400000 /* (SSP2) Device base address */
 ...
 ****************************************************************************/
/* Device base address */
#define STUARTC_BASE			0x99600000 /* standard/IR UART */
#define BTUARTC_BASE			0x98300000 /* blue tooth UART */
