...
#define RTSP_VERSION                 "IPCAM_RTSP_V1.2.0.0"
//#define OLD_IRCUT
#define MAX_CHUNNEL_NUM              2
...
#define SEND_BUF_SIZE                (512*1024)//(320*1024)//(128*1024)//(512*1024)
...
typedef struct
{
  ...
  ak_pthread_t enc_thread;
  ak_pthread_t save_thread;
  ak_pthread_t dispense_thread;
...
typedef struct
{
  ...
  ak_pthread_t recv_thread;
  ak_pthread_t send_thread;
...
enum NalUnitType  
{
	...
	NAL_UNIT_RESERVED_15, 			// 16   // Current name in the spec: BLA_W_LP  
...
typedef struct
{
  ...
  ak_mutex_t mutex_mark_date;
  ak_mutex_t mutex_serialport;
  config_user_t cur_user;
