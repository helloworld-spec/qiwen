...
#define MEDIA_LIB_VERSION   "Media Lib V1.19.20" 
...
typedef struct
{
    ...
    MEDIALIB_CALLBACK_FUN_HW_LOCK         m_FunVideoHWLock;
    MEDIALIB_CALLBACK_FUN_HW_UNLOCK       m_FunVideoHWUnlock;
}T_MEDIALIB_CB;
...
{
    AUDIO_TAG_UNKNOWN = 0,
    AUDIO_TAG_PCM_ALAW = 0x6,
    AUDIO_TAG_PCM_ULAW = 0x7,
}T_eMEDIALIB_AUDIO_TAG;
