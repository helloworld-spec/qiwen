...
var dvr_sadvr_sa=null;
 ...
 window.onload = function(){
	...
	if(str != null)
	{
		...
		{ 
			document.getElementById("userName").value = control.keywords[index]; 
			document.getElementById("password").value = control.values[index]; 
		});
	}   
...
//		jsonp: 'jsoncallback',
		...
		success: function(data, textStatus, xmlhttp){
			...
			//alert("dvr_data.user.ret :" + dvr_data.user.ret );
