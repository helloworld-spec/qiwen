...
function slider (a_init, a_tpl) {
   ...
   var userAgent = navigator.userAgent.toLowerCase();  
    ...
    //  var userAgent = navigator.userAgent.toLowerCase(); 
    //  if(userAgent.match(/(trident)\/([\w.]+)/)){ 
    //     uaMatch = userAgent.match(/trident\/([\w.]+)/); 
    //        // this.n_pathLeft=-30;
    // }  
	// generate the control's HTML
	document.write(
		'<div style="width:' + this.n_controlWidth + 'px;height:' + this.n_controlHeight + 'px;border:0; background-image:url(' + this.s_imgControl + ');  margin:5px 0px 0px 4px;" id="sl' + this.n_id + 'base">' +
